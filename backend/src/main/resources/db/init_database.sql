...
-- OpenAI GPT-5 系列
('gpt-5', 'GPT-5', 'OpenAI', 0.80, 6.00, 20.00, 1, 'OpenAI GPT-5 模型', JSON_ARRAY(), 50),
('gpt-5-mini', 'GPT-5 Mini', 'OpenAI', 0.30, 3.00, 10.00, 1, 'OpenAI GPT-5 Mini - 轻量快速', JSON_ARRAY('低价'), 60),
